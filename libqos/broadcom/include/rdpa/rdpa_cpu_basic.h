...
#define RDPA_CPU_HOST_RSV_QUEUES 4 /**< Min/RSV number of queues on CPU host port */
#else
#define RDPA_CPU_HOST_RSV_QUEUES 2 /**< Min/RSV number of queues on CPU host port */
#endif
#define RDPA_CPU_WLAN_RSV_QUEUES 3 /**< Reserved number of queues on CPU WLAN port */
#define RDPA_CPU_XTM_RSV_QUEUES 2 /**< Min/RSV number of queues on CPU XTM port */
